/* eslint-disable max-depth */ function _define_property(obj, key, value) {
    if (key in obj) {
...
export class CommandManager extends Collection {
        ...
        try {
            ...
            for (const category of categories){
                try {
                    ...
                    const files = (await fs.readdir(resolve(this.path, category))).filter((f)=>f !== "category.meta.js");
                    let disabledCount = 0;
                    ...
                    if (disabledCount > 0) {
                        this.client.logger.info(`${disabledCount} out of ${files.length} commands in ${category} category is disabled.`);
                    }
                } catch (err) {
    ...
    constructor(client, path){
        ...
        _define_property(this, "isReady", void 0);
        _define_property(this, "categories", void 0);
        _define_property(this, "aliases", void 0);
        _define_property(this, "cooldowns", void 0);
        this.client = client;
        this.path = path;
        this.isReady = false;
