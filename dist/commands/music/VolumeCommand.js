...
export let VolumeCommand = class VolumeCommand extends BaseCommand {
    async execute(ctx) {
        ...
        if (isNaN(volume)) {
            const buttons = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId("10").setLabel("10%").setStyle(ButtonStyle.Primary), new ButtonBuilder().setCustomId("25").setLabel("25%").setStyle(ButtonStyle.Primary), new ButtonBuilder().setCustomId("50").setLabel("50%").setStyle(ButtonStyle.Primary), new ButtonBuilder().setCustomId("75").setLabel("75%").setStyle(ButtonStyle.Primary), new ButtonBuilder().setCustomId("100").setLabel("100%").setStyle(ButtonStyle.Primary));
