/* eslint-disable @typescript-eslint/no-non-null-asserted-optional-chain, @typescript-eslint/no-unnecessary-condition */ function _define_property(obj, key, value) {
    if (key in obj) {
...
export let HelpCommand = class HelpCommand extends BaseCommand {
    ...
    constructor(...args){
        super(...args);
        _define_property(this, "listEmbed", createEmbed("info").setAuthor({
        ...
        _define_property(this, "infoEmbed", createEmbed("info").setThumbnail("https://api.clytage.org/assets/images/question_mark.png"));
    }
};
